...
fn test_string_with_underscores() {
    assert_single_token(
        r#""hello_world""#,
        Token::String(r#""hello_world""#.to_string()),
    );
}
...
fn test_string_escape_carriage_return() {
    assert_single_token(
        r#""hello\rworld""#,
        Token::String(r#""hello\rworld""#.to_string()),
    );
}
...
fn test_string_escape_backspace() {
    assert_single_token(
        r#""hello\bworld""#,
        Token::String(r#""hello\bworld""#.to_string()),
    );
}
...
fn test_string_escape_formfeed() {
    assert_single_token(
        r#""hello\fworld""#,
        Token::String(r#""hello\fworld""#.to_string()),
    );
}
...
fn test_fstring_with_simple_interpolation() {
    assert_single_token(
        r#"f"Value: {x}""#,
        Token::FString(r#"f"Value: {x}""#.to_string()),
    );
}
...
fn test_fstring_with_multiple_interpolations() {
    assert_single_token(
        r#"f"x={x}, y={y}""#,
        Token::FString(r#"f"x={x}, y={y}""#.to_string()),
    );
}
...
fn test_fstring_with_expression() {
    assert_single_token(
        r#"f"Result: {x + y}""#,
        Token::FString(r#"f"Result: {x + y}""#.to_string()),
    );
}
...
fn test_fstring_with_nested_braces() {
    assert_single_token(
        r#"f"Array: {[1, 2, 3]}""#,
        Token::FString(r#"f"Array: {[1, 2, 3]}""#.to_string()),
    );
}
...
fn test_fstring_escape_tab() {
    assert_single_token(
        r#"f"Name:\t{name}""#,
        Token::FString(r#"f"Name:\t{name}""#.to_string()),
    );
}
...
fn test_fstring_escape_quote() {
    ...
    assert_single_token(
        r#"f"He said \"Hello\"""#,
        Token::FString(r#"f"He said \"Hello\"""#.to_string()),
    );
}
...
fn test_fstring_escape_quote_with_interpolation() {
    assert_single_token(
        r#"f"He said \"{name}\" to me""#,
        Token::FString(r#"f"He said \"{name}\" to me""#.to_string()),
    );
}
...
fn test_fstring_escape_backslash() {
    assert_single_token(
        r#"f"Path: C:\\Users\\{user}""#,
        Token::FString(r#"f"Path: C:\\Users\\{user}""#.to_string()),
    );
}
...
fn test_fstring_format_float_precision() {
    assert_single_token(
        r#"f"Pi: {pi:.2f}""#,
        Token::FString(r#"f"Pi: {pi:.2f}""#.to_string()),
    );
}
...
fn test_fstring_format_hex() {
    assert_single_token(
        r#"f"Hex: {num:x}""#,
        Token::FString(r#"f"Hex: {num:x}""#.to_string()),
    );
}
...
fn test_fstring_format_octal() {
    assert_single_token(
        r#"f"Octal: {num:o}""#,
        Token::FString(r#"f"Octal: {num:o}""#.to_string()),
    );
}
...
fn test_fstring_format_scientific() {
    assert_single_token(
        r#"f"Scientific: {num:.2e}""#,
        Token::FString(r#"f"Scientific: {num:.2e}""#.to_string()),
    );
}
...
fn test_fstring_mixed_formats() {
    assert_single_token(
        r#"f"x={x:x}, y={y:.2f}""#,
        Token::FString(r#"f"x={x:x}, y={y:.2f}""#.to_string()),
    );
}
...
fn test_fstring_no_interpolation() {
    assert_single_token(
        r#"f"just text""#,
        Token::FString(r#"f"just text""#.to_string()),
    );
}
...
fn test_string_unicode_arabic() {
    assert_single_token(
        r#""مرحبا بالعالم""#,
        Token::String(r#""مرحبا بالعالم""#.to_string()),
    );
}
...
fn test_string_unicode_mixed() {
    assert_single_token(
        r#""Hello 世界 🌍""#,
        Token::String(r#""Hello 世界 🌍""#.to_string()),
    );
}
...
fn test_fstring_unicode_with_interpolation() {
    assert_single_token(
        r#"f"Hello {name} 👋""#,
        Token::FString(r#"f"Hello {name} 👋""#.to_string()),
    );
}
...
fn test_multiple_strings_concatenation() {
    ...
    assert_eq!(
        lexer.next(),
        Some(Ok(Token::String(r#""hello""#.to_string())))
    );
    assert_eq!(lexer.next(), Some(Ok(Token::Plus)));
    assert_eq!(
        lexer.next(),
        Some(Ok(Token::String(r#""world""#.to_string())))
    );
...
fn test_fstring_in_print() {
    ...
    assert_eq!(
        lexer.next(),
        Some(Ok(Token::FString(r#"f"x = {x}""#.to_string())))
    );
...
fn test_complex_escape_pattern_path() {
    assert_single_token(
        ...
        Token::String(r#""C:\\Users\\Admin\\file.txt""#.to_string()),
    );
}
