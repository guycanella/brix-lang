        ...
        statements: vec![
            ...
            Stmt::dummy(StmtKind::Expr(Expr::dummy(ExprKind::FString {
                parts: vec![
                    ...
                    FStringPart::Expr {
                        expr: Box::new(Expr::dummy(ExprKind::Identifier("value".to_string()))),
                        format: None,
                    },
                ],
            }))),
    ...
    let program = Program {
        statements: vec![
            Stmt::dummy(StmtKind::VariableDecl {
                ...
                type_hint: None,
                value: Expr::dummy(ExprKind::Literal(Literal::String("Users".to_string()))),
                is_const: false,
            }),
            Stmt::dummy(StmtKind::Expr(Expr::dummy(ExprKind::FString {
                parts: vec![
                    ...
                    FStringPart::Expr {
                        expr: Box::new(Expr::dummy(ExprKind::Identifier("folder".to_string()))),
                        format: None,
                    },
                ],
            }))),
...
fn test_string_concatenation() {
    // "Hello" + " " + "World"
    let program = Program {
        statements: vec![Stmt::dummy(StmtKind::Expr(binary(
            BinaryOp::Add,
            binary(
                BinaryOp::Add,
    ...
    let program = Program {
        statements: vec![
            Stmt::dummy(StmtKind::VariableDecl {
                name: "name".to_string(),
                type_hint: None,
                value: Expr::dummy(ExprKind::Literal(Literal::String("Alice".to_string()))),
                is_const: false,
            }),
...
fn test_string_equality() {
    ...
    let program = Program {
        statements: vec![Stmt::dummy(StmtKind::Expr(binary(
            BinaryOp::Eq,
            Expr::dummy(ExprKind::Literal(Literal::String("test".to_string()))),
            Expr::dummy(ExprKind::Literal(Literal::String("test".to_string()))),
        )))],
    };
    let result = compile_program(program);
...
fn test_string_comparison_greater_than() {
    ...
    let program = Program {
        statements: vec![Stmt::dummy(StmtKind::Expr(binary(
            BinaryOp::Gt,
            Expr::dummy(ExprKind::Literal(Literal::String("z".to_string()))),
            Expr::dummy(ExprKind::Literal(Literal::String("a".to_string()))),
        )))],
    };
    let result = compile_program(program);
        ...
        statements: vec![
            ...
            Stmt::dummy(StmtKind::Expr(Expr::dummy(ExprKind::FString {
                parts: vec![
                    FStringPart::Text("Result: ".to_string()),
                    FStringPart::Expr {
                        expr: Box::new(Expr::dummy(ExprKind::Ternary {
    ...
    let program = Program {
        statements: vec![
            ...
            Stmt::dummy(StmtKind::VariableDecl {
                name: "c".to_string(),
                type_hint: None,
                value: Expr::dummy(ExprKind::Literal(Literal::Int(8))),
                is_const: false,
            }),
            Stmt::dummy(StmtKind::Expr(Expr::dummy(ExprKind::FString {
                parts: vec![
                    FStringPart::Expr {
                        expr: Box::new(Expr::dummy(ExprKind::Identifier("a".to_string()))),
                        format: None,
                    },
                    FStringPart::Text(" + ".to_string()),
                    FStringPart::Expr {
                        expr: Box::new(Expr::dummy(ExprKind::Identifier("b".to_string()))),
                        format: None,
                    },
                    FStringPart::Text(" = ".to_string()),
                    FStringPart::Expr {
                        expr: Box::new(Expr::dummy(ExprKind::Identifier("c".to_string()))),
                        format: None,
                    },
                ],
            }))),
